<template>
    <div class="box">
        <!-- 输入框 -->
        <i-form :model="formItem" :label-width="90" label-position="left" id="form">
            <Row type="flex">
        ...
        <Row>
            <Col span="18">
               <Button type="primary" class="btn"><Icon type="ios-list-box-outline"  @click="modal1 = true" />新增</Button>
               <Button type="primary" class="btn"><Icon type="ios-create-outline" />修改</Button>
               <Button type="primary" class="btn"><Icon type="ios-trash-outline"/>删除</Button>
            </Col>
